...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--train_dataset', type=bool, default=True, help='validation dataset call')
        #validation parameters
        parser.add_argument('--val_freq', type=int, default=400, help='frequency of calling validation analysis')
        parser.add_argument('--num_val', type=int, default=400, help='frequency of calling validation analysis')
        # lambda parameters
