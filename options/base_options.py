...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--sort', type=int, default=0, help='which bin is selected only for validating models')
        parser.add_argument('--job', type=str, default=None, help='job option')
        ...
        parser.add_argument('--custom_masks_path', type=str, default=None,help='if None, import mask data from a default path. Otherwise, import from the custom path')
        parser.add_argument('--custom_paired_path', type=str, default=None,help='if None, import aligned image data from a default path. Otherwise, import from the custom path')
        parser.add_argument('--generate_paths_data_csv', type=bool, default=False, help='if True, generate csv with data path. Otherwise, import a ready to use csv')
    ...
    def parse(self):
        ...
        print ('GPU with device %d'%device)
