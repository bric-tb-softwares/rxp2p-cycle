...
if __name__ == '__main__':
    ...
    for fold in range(opt.n_folds):
        ...
        for val in range(n_sorts):
            opt.sort = val
            if opt.model == 'test2cycle':
                opt.name = './shenzhen_santacasa_test_'+ str(fold) +'_sort_' + str(val)
                if opt.gen_train_dataset:
                    name_gen = './results/shenzhen_santacasa_test_'+ str(fold) +'_sort_' + str(val) + '/TRAIN/'
                if opt.gen_val_dataset:
                    name_gen = './results/shenzhen_santacasa_test_'+ str(fold) +'_sort_' + str(val) + '/VAL/'
                if opt.gen_test_dataset:
                    name_gen = './results/shenzhen_santacasa_test_'+ str(fold) +'_sort_' + str(val) +  '/TEST/'
            else:
                opt.name = './santacasa_test_'+ str(fold) +'_sort_' + str(val)
                if opt.gen_train_dataset:
                    name_gen = './results/santacasa_test_'+ str(fold) +'_sort_' + str(val) + '/TRAIN/'
                if opt.gen_val_dataset:
                    name_gen = './results/santacasa_test_'+ str(fold) +'_sort_' + str(val) + '/VAL/'
                if opt.gen_test_dataset:
                    name_gen = './results/santacasa_test_'+ str(fold) +'_sort_' + str(val) +  '/TEST/'
