...
taskname = 'user.otto.tavares.SantaCasa_imageamento_anonimizado_valid.cycle_notb_v1.r1_exemplo'
...
--token {TOKEN} \
--project cycle_shenzhen_ntb_santacasa_exemplo \
--name %JOB_NAME \
--preprocess resize_and_scale_width \
--use_wandb \
--wandb_fold_id exemplo_%JOB_NAME \
--no_flip  \
