...
basepath = '/home/brics/public/brics_data/Manaus/c_manaus/fake_images'

dataset_name = 'user.otto.tavares.Manaus.c_manaus.pix2pix_v1.notb.r1.samples'
#dataset_name = 'user.otto.tavares.Manaus.c_manaus.pix2pix_v1.tb.r1.samples'
has_tb = False
#has_tb = True
...
for test in range(10):
    for sort in range(9):
        ...
        for key, path in paths.items():
            for f in glob.glob(basepath + '/' + path + '/*.png'):
