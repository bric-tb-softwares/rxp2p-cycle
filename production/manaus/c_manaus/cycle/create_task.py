...
taskname = 'user.otto.tavares.Manaus.c_manaus.cycle_v1.r2'
image = '/mnt/brics_data/images/p2p-cycle_base.sif'
repo_path = '/home/otto.tavares/public/iltbi/rxp2p-cycle'
jobs_path = '/home/otto.tavares/public/iltbi/rxp2p-cycle/production/manaus/c_manaus/cycle/jobs'
...
--dataroot /home/brics/public/brics_data/Manaus/c_manaus/ \
--dataset_download_dir /home/otto.tavares/public/iltbi/train/images \
--model cycle_gan \
--dataset_mode unalignedskfoldcmanaus \
--token {TOKEN} \
--name %JOB_NAME \
