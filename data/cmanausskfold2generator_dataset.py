...
class CManausSkfold2GeneratorDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        masks_available = pd.read_csv('/home/brics/public/brics_data/Manaus/c_manaus/masks/dicionario_masks_c_manaus.csv', sep = ";")[['project_id','binary_limiar']].dropna()
        ...
        if (opt.isTB == True):
            ...
            if opt.train_dataset:
                ...
                if self.gen_test:
                    ...
                    self.AB_paths = [opt.dataroot + img_nm + '.jpg' for img_nm in self.test_tb['project_id'].tolist() if img_nm in masks_available['project_id'].str.replace(r'^mask_(.*)\.jpg$', r'\1', regex=True).tolist()]
            ...
            if opt.train_dataset:
                ...
                if self.gen_test:
                    ...
                    self.AB_paths = [opt.dataroot + img_nm + '.jpg' for img_nm in self.test_ntb['project_id'].tolist() if img_nm in masks_available['project_id'].str.replace(r'^mask_(.*)\.jpg$', r'\1', regex=True).tolist()]
