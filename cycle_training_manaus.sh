...
train.py --dataset_download_dir /home/otto.tavares/public/iltbi/train/images --download_imgs --model cycle_gan --dataset_mode unalignedskfoldmanaus --token b16fe0fc92088c4840a98160f3848839e68b1148 --project cycle_manaus --name tunning_manaus --preprocess resize_and_scale_width --use_wandb --wandb_fold_id tunning_manaus_v001 --no_flip  --wandb_entity otavares  --gpu_ids 0 --n_epochs 100 --n_epochs_decay 100 --load_size 256 --crop_size 256 --isTB --test 0 --sort 0
